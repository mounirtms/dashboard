...
export default function LogViewerPage() {
  // Default to Production site (active website) — most useful on first load
  const [site, setSite] = useState('prod');
  const [type, setType] = useState('system');  // Magento system log
  ...
  const SITES = [
    { key: 'prod',  name: '🟢 Production (active)' },
