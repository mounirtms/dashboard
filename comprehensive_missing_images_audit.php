<?php
/**
 * Comprehensive Missing Images Audit
 * Checks all products for missing image files and exports CSV
 */
...
// Database connection
$dbConfig = require __DIR__ . '/app/etc/env.php';
$host = '127.0.0.1';
$port = '3307';
$dbName = $dbConfig['db']['connection']['default']['dbname'];
$username = $dbConfig['db']['connection']['default']['username'];
$password = $dbConfig['db']['connection']['default']['password'];
