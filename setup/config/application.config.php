...
return [
    'modules' => [
        ...
        'Magento_CatalogWidgetGraphQl' => 1,
        'Magento_CheckoutAgreementsGraphQl' => 1,
        'Magento_MediaContentCatalogIntegration' => 1,
        'Magento_Config' => 1,
        ...
        'Magento_InventoryBundleProductGraphQl' => 1,
        ...
        'Magento_ConfigurableProductInventory' => 1,
        'Magento_InventoryCheckout' => 1,
        'Magento_InventoryCheckoutFrontendUi' => 1,
        ...
        'Magento_InventoryExportStockAdminUi' => 1,
        'Magento_InventoryGraphQl' => 1,
        'Magento_InventoryGroupedProduct' => 1,
        'Magento_InventoryGroupedProductAdminUi' => 1,
        'Magento_InventoryGroupedProductGraphQl' => 1,
        ...
        'Magento_Shipping' => 1,
        'Magento_InventorySourceDeduction' => 1,
        ...
        'Magento_MediaGalleryFrontend' => 1,
        ...
        'Magento_OrderCancellationAdminUi' => 1,
        'Magento_OrderCancellationFrontend' => 1,
        'Magento_OrderCancellationGraphQl' => 1,
        'Magento_InventoryInStorePickupFrontend' => 1,
        'Magento_PageCache' => 1,
        'Magento_CmsPageBuilder' => 1,
        'Magento_CatalogPageBuilder' => 1,
        ...
        'Magento_QuoteGraphQl' => 1,
        'Magento_QuoteInventory' => 1,
        'Magento_QuoteMultishipping' => 1,
        'Magento_QuoteOptionsApi' => 1,
