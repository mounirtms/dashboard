...
class ShippingProgress implements HttpGetActionInterface
{
    ...
    /**
     * Execute shipping conditions check
     *
    ...
    public function execute(): ResultInterface
    {
        ...
        try {
            ...
            $this->logger->error('[MAB Visual Effects] Shipping conditions error: ' . $e->getMessage());
            
            return $result->setData([
                'success' => false,
                'message' => __('Unable to check shipping conditions'),
                'error' => $e->getMessage()
            ]);
        }
    }
