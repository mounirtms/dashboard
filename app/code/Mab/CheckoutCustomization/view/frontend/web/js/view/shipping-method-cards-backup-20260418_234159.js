...
define([
    ...
    return Component.extend({
        ...
        /**
         * Conditional logging - only when debug mode is active
         */
        log: function() {
            if (this.debugMode && typeof console !== 'undefined') {
                console.log.apply(console, ['[Shipping Cards]'].concat(Array.prototype.slice.call(arguments)));
            }
        },

        warn: function() {
            if (this.debugMode && typeof console !== 'undefined') {
                console.warn.apply(console, ['[Shipping Cards]'].concat(Array.prototype.slice.call(arguments)));
            }
        },

        error: function() {
            if (typeof console !== 'undefined') {
                console.error.apply(console, ['[Shipping Cards]'].concat(Array.prototype.slice.call(arguments)));
            }
        },
