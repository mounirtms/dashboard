...
class AICommands {
    ...
    public function cmd_report(int $chatId, string $args, BotHandler $bot): array {
        ...
        try {
            ...
            return $bot->sendMessage($chatId, $report, 'MarkdownV2');
        } catch (Exception $e) {
    ...
    public function cmd_query(int $chatId, string $args, BotHandler $bot): array {
        ...
        try {
            ...
            return $bot->sendMessage($chatId, $response, 'MarkdownV2');
        } catch (Exception $e) {
    ...
    public function cmd_cache_clear(int $chatId, string $args, BotHandler $bot): array {
        $cleared = $this->qoderCLI->clearCache();
        $message = $cleared ? "✅ AI cache cleared successfully." : "ℹ️ No cache to clear.";
