...
<div class="slide" id="s2">
  ...
  <div class="kpi-grid g4" style="margin-bottom:12px">
    ...
    <div class="kpi-card green"><div class="kpi-label">All-Time Revenue</div><div class="kpi-val">28.6M</div><div class="kpi-sub">DZD · 4,484 CMD_Done orders</div><div class="kpi-delta" style="color:var(--ok)">2.78M DZD H1 2026 · AOV 5,591</div></div>
    <div class="kpi-card orange"><div class="kpi-label">Cancel Rate H1 2026</div><div class="kpi-val">35.2%</div><div class="kpi-sub">288 cancelled / 819 total</div><div class="kpi-delta" style="color:var(--muted)">Normal for Algerian COD model</div></div>
  </div>
  <div class="kpi-grid g4" style="margin-bottom:12px">
...
<div class="slide section-divider" id="s11">
  ...
  <div class="div-subtitle">7,788 total orders · 4,484 CMD_Done · 9,275 customers · 2022–Jul 2026 · MariaDB prod · Cancel rate 35.2% (Algerian COD)</div>
  <div class="div-tags">
...
<div class="slide" id="s12">
  ...
  <div class="slide-subtitle">Source: MariaDB · sales_order WHERE status='CMD_Done' · 498 CMD_Done H1 2026 · 819 total orders · DZD</div>
...
<div class="slide" id="s13">
  ...
  <div class="slide-subtitle">Source: MariaDB sales_order · 819 orders H1 2026 · Statuts personnalis&#233;s Alg&#233;riens (COD) · Taux annulation 35.2% = NORMAL march&#233; DZ</div>
  <div class="grid-2" style="flex:1;gap:16px">
    <div class="panel" style="flex:1;display:flex;flex-direction:column">
        ...
        <table class="data-table">
          ...
          <tbody>
            <tr style="background:rgba(34,197,94,.08)">
              ...
              <td class="num" style="color:#22c55e">63.5%</td>
            </tr>
    ...
    <div class="col">
      <div class="panel">
        ...
        <table class="data-table" style="font-size:12px">
          ...
          <tbody>
            ...
            <tr><td>AOV Moyen (DZD)</td><td class="num">DZD 4,870</td><td class="num">DZD 5,591</td><td><span style="color:var(--ok)">▲ +14.7%</span></td></tr>
            <tr><td>Taux Annulation</td><td class="num">28.4%</td><td class="num">35.2%</td><td><span style="color:var(--warn)">COD normal</span></td></tr>
      ...
      <div class="panel">
        ...
        <div style="font-size:11px;color:var(--muted);line-height:1.7">
          ...
          <div>&#x2705; AOV: <strong style="color:#fff">+14.7%</strong> (4,870 &#x2192; 5,613 DZD)</div>
...
<div class="slide" id="s17b" style="padding:24px 32px 14px">
  ...
  <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:8px;margin-bottom:10px">
    ...
    <div class="kpi-card" style="border-color:rgba(148,163,184,.3)">
      ...
      <div style="font-size:10px;color:#64748b;margin-top:2px">CMD_Done H1 · 2.78M DZD</div>
    </div>
  </div>
  ...
  <div class="scroll" style="flex:1">
    <table class="data-table">
      ...
      <tbody>
        ...
        <tr><td>9</td><td><strong>819 total orders Jan–Jun 2026 (498 CMD_Done)</strong></td><td style="font-size:10px">MariaDB sales_order COUNT(*)</td><td><span class="conf conf-high">HIGH</span></td><td style="font-size:10px">Direct DB query, deterministic</td></tr>
...
<div class="slide" id="s36" style="padding:24px 32px 14px">
  ...
  <div class="slide-subtitle">Orders · Revenue · Dev velocity · Customers · Jan–Jun same-period · Source: MariaDB + GitLab</div>
      ...
      <div class="panel" style="flex:1">
        ...
        <table class="data-table" style="font-size:11px">
          ...
          <tbody>
            ...
            <tr><td>Total Revenue</td><td class="num">2.76M DZD</td><td class="num">2.79M DZD</td><td><span style="color:var(--ok)">&#x25B2; +1.1%</span></td></tr>
            <tr><td>Avg Order Value</td><td class="num">6,200 DZD</td><td class="num">5,591 DZD</td><td><span style="color:var(--warn)">&#x25BC; -9.8%</span></td></tr>
            <tr><td>Cancel Rate</td><td class="num">~27%</td><td class="num">35.2%</td><td><span style="color:var(--warn)">&#x25B2; +8.2pp</span></td></tr>
...
const NOTES = {
  s1:  'v6.4.0. Audit: Jul 12, 2026. Prod: technostationery.com (Magento 2.4.6-p15). Dev/Staging: dev.technostationery.com. Beta site REMOVED. PIM REMOVED. CI/CD pipeline live Jul 1 (Damien Louis, DND France). Yalidine: integration complete on dev, pending prod deploy. 9,275 customers. 4,484 valid orders. 28.6M DZD. 2,215 GitLab commits.',
  s2:  'KPIs from real DB. 498 CMD_Done H1 2026 (+11.9% vs 445 H1 2025). 9,275 customers (incl. 3,278 bulk-migrated May). 28.6M DZD all-time revenue. Cancel rate 35.2% — NORMAL for Algerian COD (industry 30-50%). 1,859 GitLab commits H1 2026 (+1449% vs 120 H1 2025). AOV=5,591 DZD.',
  ...
  s11: 'Phase 3 divider. MariaDB prod: 7,788 total orders. 4,484 CMD_Done (valid). 2,365 cancelled (35.2% — NORMAL for DZ e-commerce COD model, industry 30-50%). 9,275 registered customers. 2022-2026 period.',
  s12: 'Monthly CMD_Done 2026: Jan=117, Feb=68, Mar=75, Apr=81, May=88, Jun=70. Total H1=498. 819 total created. 288 cancelled (35.2%). Jun peak in cancellations (43.9%). Feb lowest (quieter period). Yalidine: 183/498 orders (36.7%).',
  s13: 'Cancel breakdown: Annulee_a_la_confirmation=163(55.6%), Annulee_a_la_preparation=80, Annulee_a_la_livraison=44, canceled(Magento)=6. Custom Algerian workflow statuses. COD cash-on-delivery model = high confirmation-stage cancels. DZ industry benchmark: 30-50%.',
  ...
  s15: 'Top products 2026: art supplies dominate. #1 Carton Toile (289 units, 63K DZD). #2 Toile Chassis (126u, 112K DZD). 9,618 catalog products. 694 categories. Yalidine: 183/498 orders. AOV=5,591 DZD. H1 revenue=2.78M DZD.',
  ...
  s17: 'YoY: CMD_Done orders +11.9% (445->498). Revenue H1 2025=2.76M, H1 2026=2.78M (+0.7%). AOV H1 2025=6,200 vs H1 2026=5,591 (-9.8%). Cancel rate rose 8.2pp. Customer count: 577 organic in 2025 vs 537 organic in 2026 + 3278 bulk.',
  s17b:'5-year CMD_Done: 2022=311, 2023=1,359(+337%), 2024=1,163(-14%), 2025=1,133(-2.6%), 2026=498(H1 partial). Revenue: 2022=2.3M, 2023=7.8M, 2024=8.3M, 2025=7.4M. All-time: 4,484 orders, 28.6M DZD. Peak year: 2023.',
  ...
  s33: 'Roadmap: 1. phpinfo delete (10min, CRITICAL). 2. chmod world-writable (script). 3. .git Apache block. 4. Magento 2.4.7-p3 CVE. 5. Amasty upgrades. 9. YALIDINE PROD DEPLOY (carriers/yalidine/active=1) — biggest pending feature. Via CI/CD pipeline. Aug target.',
  ...
  s35: 'Thank you. Prod: technostationery.com. Dev: dev.technostationery.com. Beta REMOVED. PIM REMOVED. 9,275 customers · 4,484 orders · 28.6M DZD · 2,215 commits · 46 MAB modules. Yalidine on dev, Q3 prod deploy. CI/CD live. MounirAb lead developer. 8 phases complete.'
};
