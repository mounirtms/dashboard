...
#algeria-map .wilaya{cursor:pointer;transition:fill .2s}#algeria-map .wt { fill:#cbd5e1; font-size:7px; font-family:Inter,sans-serif; font-weight:600; pointer-events:none; }#algeria-map .wn { fill:#93c5fd; font-size:6.5px; font-family:Inter,sans-serif; pointer-events:none; font-weight:700; }#algeria-map .wilaya rect { cursor:pointer; transition:filter .15s, opacity .15s; }#algeria-map .wilaya:hover rect { filter:brightness(1.9) !important; }#algeria-map .wilaya.dimmed rect { opacity:.2; }#algeria-map .wilaya.highlighted rect { filter:brightness(2.2) drop-shadow(0 0 5px #3b82f6); }
#algeria-map .wilaya rect{cursor:pointer;transition:filter .15s,opacity .15s}
#algeria-map .wilaya:hover rect{filter:brightness(1.8)!important}
#algeria-map .wilaya.dimmed rect{opacity:.2}
#algeria-map .wilaya.highlighted rect{filter:brightness(2) drop-shadow(0 0 4px #3b82f6)}
.map-filter-btn{
...
<div class="slide" id="s1">
  <div class="cover-logo" style="display:flex;align-items:center;gap:12px"><img src="/presentation/techno-logo.png" alt="TechnoStationery" style="height:36px;filter:brightness(0) invert(1);opacity:.9"><span>Executive Audit Report 2026</span></div>
  ...
  <div class="cover-meta">
    ...
    <span><strong>Stack:</strong> Magento 2.4.7-p3 · PHP 8.2 · MariaDB 10.6.17</span>
    <span><strong>OS:</strong> AlmaLinux 9.6 (RHEL 9)</span>
  </div>
</div>
...
<div class="slide" id="s2">
  ...
  <div class="slide-title">Key Performance Indicators — Jan–Jul 2026</div>
  <div class="slide-subtitle">All figures sourced from MariaDB, Imunify360, /var/log/secure, ecomscan, and git history</div>
  <div class="kpi-grid g4" style="margin-bottom:12px">
    ...
    <div class="kpi-card cyan"><div class="kpi-label">New Customers</div><div class="kpi-val">5,243</div><div class="kpi-sub">Jan–Jun 2026</div><div class="kpi-delta" style="color:var(--ok)">▲ +8.2% YoY</div></div>
    ...
    <div class="kpi-card orange"><div class="kpi-label">Peak Load</div><div class="kpi-val">15.37</div><div class="kpi-sub">May 5 crisis (resolved)</div><div class="kpi-delta" style="color:var(--ok)">▼ now 2.04</div></div>
  </div>
  <div class="kpi-grid g4" style="margin-bottom:12px">
    <div class="kpi-card purple"><div class="kpi-label">Redis Hit Rate</div><div class="kpi-val">84.3%</div><div class="kpi-sub">Post-optimization</div><div class="kpi-delta" style="color:var(--ok)">▲ from 5.7% (Varnish)</div></div>
    <div class="kpi-card blue"><div class="kpi-label">Git Commits</div><div class="kpi-val">96</div><div class="kpi-sub">1 author, 16 branches</div><div class="kpi-delta" style="color:var(--muted)">Tag: emergency-fix-20260502</div></div>
  ...
  <div class="kpi-grid g4">
    ...
    <div class="kpi-card blue"><div class="kpi-label">Ecomscan Issues</div><div class="kpi-val">125</div><div class="kpi-sub">Jul 11 (0 malware)</div><div class="kpi-delta" style="color:var(--warn)">▲ 119→125 · Jul 11 latest scan</div></div>
...
<div class="slide section-divider" id="s4">
  ...
  <div class="div-subtitle">96 commits · 1 author · 16 branches · Emergency tag May 2 · Evidence: github.com/mounirtms/dashboard</div>
  <div class="div-tags">
    <span class="badge badge-blue">96 Commits</span>
    <span class="badge badge-cyan">Branch: genspark_ai_developer</span>
    <span class="badge badge-orange">Tag: emergency-fix-20260502</span>
    <span class="badge badge-purple">1 Author</span>
  </div>
</div>
...
<div class="slide" id="s5">
  ...
  <div class="slide-title">Git Commit Analysis</div>
  <div class="slide-subtitle">Source: github.com/mounirtms/dashboard — 96 commits, branch genspark_ai_developer</div>
  <div class="grid-2" style="flex:1;gap:16px">
    <div class="col">
      <div class="panel" style="flex:1">
        <h3>Monthly Commit Velocity</h3>
    ...
    <div class="col">
      <div class="panel" style="flex:.6">
        ...
        <div class="chart-wrap"><canvas id="chartCommitType"></canvas></div>
      </div>
      <div class="panel">
        <h3>Repository Summary</h3>
        <div class="pbar-row"><div class="pbar-label"><span>Total commits</span><span>96</span></div><div class="pbar-track"><div class="pbar-fill" style="width:96%;background:var(--accent)"></div></div></div>
        <div class="pbar-row"><div class="pbar-label"><span>feat commits</span><span>38</span></div><div class="pbar-track"><div class="pbar-fill" style="width:40%;background:var(--ok)"></div></div></div>
        <div class="pbar-row"><div class="pbar-label"><span>fix commits</span><span>32</span></div><div class="pbar-track"><div class="pbar-fill" style="width:33%;background:var(--warn)"></div></div></div>
        <div class="pbar-row"><div class="pbar-label"><span>chore/refactor</span><span>26</span></div><div class="pbar-track"><div class="pbar-fill" style="width:27%;background:var(--accent3)"></div></div></div>
        <div style="margin-top:8px;font-size:11px;color:var(--muted)">
          <div style="margin-bottom:3px">🏷️ Tag: <strong style="color:#fff">emergency-fix-20260502</strong> — May 2, 2026</div>
          <div style="margin-bottom:3px">🌿 Active branch: <strong style="color:#fff">genspark_ai_developer</strong></div>
          <div>⚠️ Single author — shared credential risk unverifiable <span class="conf conf-low">LOW CONF</span></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="slide" id="s6">
  <div class="section-label">Phase 1 — Repository Audit</div>
  <div class="slide-title">Development Timeline — Jan–Jul 2026</div>
  <div class="slide-subtitle">Key milestones reconstructed from git log, commit messages, and audit reports</div>
  <div class="scroll" style="flex:1">
    <div class="timeline" style="gap:4px">
      <div class="tl-item"><div class="tl-time">Jan 2026</div><div class="tl-dot blue"></div><div class="tl-content"><div class="tl-title">Project Initialization</div><div class="tl-detail">Dashboard repository created. Initial commit. TypeScript frontend scaffolded.</div><div class="tl-src">Source: git log --oneline (first commit)</div></div></div>
      <div class="tl-item"><div class="tl-time">Mar 2026</div><div class="tl-dot cyan"></div><div class="tl-content"><div class="tl-title">Feature Development Accelerates</div><div class="tl-detail">28 commits in March. Apache logs show 640K requests (anomaly — root cause unknown).</div><div class="tl-src">Source: git log, Apache access_log</div></div></div>
      <div class="tl-item"><div class="tl-time">Apr 11</div><div class="tl-dot purple"></div><div class="tl-content"><div class="tl-title">Security Updates Applied</div><div class="tl-detail">3/4 CVEs patched: phpseclib 3.0.50→3.0.51, symfony/http-client, firebase/jwt mitigated. CVE-2024-34102 deferred.</div><div class="tl-src">Source: SECURITY_UPDATES_APPLIED.md</div></div></div>
      <div class="tl-item"><div class="tl-time">May 2</div><div class="tl-dot orange"></div><div class="tl-content"><div class="tl-title">Emergency Fix Tag Created</div><div class="tl-detail">Git tag <code style="color:var(--accent)">emergency-fix-20260502</code> created. Indicates pre-crisis preparedness.</div><div class="tl-src">Source: git tag --list</div></div></div>
      <div class="tl-item"><div class="tl-time">May 5 00:00</div><div class="tl-dot red"></div><div class="tl-content"><div class="tl-title">🚨 Server Crisis Onset — Load 15.37</div><div class="tl-detail">CPU idle 0.7%. MariaDB 96% CPU. QoderCLI consuming 76.4% CPU. 5 Magento sites unresponsive.</div><div class="tl-src">Source: SERVER_FIX_COMPLETE_REPORT.md</div></div></div>
      <div class="tl-item"><div class="tl-time">May 5 01:30</div><div class="tl-dot orange"></div><div class="tl-content"><div class="tl-title">Root Cause Identified &amp; Contained</div><div class="tl-detail">QoderCLI PID 985327 killed (freed 76% CPU). Second instance PID 912388 killed (freed 16% CPU). MariaDB restarted.</div><div class="tl-src">Source: SERVER_FIX_COMPLETE_REPORT.md</div></div></div>
      <div class="tl-item"><div class="tl-time">May 5 02:00</div><div class="tl-dot yellow"></div><div class="tl-content"><div class="tl-title">Configuration Hardening Applied</div><div class="tl-detail">MariaDB buffer pool 128MB→8GB. PHP-FPM dynamic→static 66 processes. Pragma header removed (re-enabled Cloudflare cache).</div><div class="tl-src">Source: AUDIT_COMPLETION_STATUS.txt</div></div></div>
      <div class="tl-item"><div class="tl-time">May 5 04:00</div><div class="tl-dot green"></div><div class="tl-content"><div class="tl-title">✅ Load Normalized — 2.04</div><div class="tl-detail">86.5% load reduction achieved. CPU idle 96.9%. Memory freed: 1.2GB→16GB. All services healthy.</div><div class="tl-src">Source: SERVER_FIX_COMPLETE_REPORT.md (Load 2.08)</div></div></div>
      <div class="tl-item"><div class="tl-time">Jun 8</div><div class="tl-dot cyan"></div><div class="tl-content"><div class="tl-title">Imunify360 Full Background Scan</div><div class="tl-detail">Complete scan of all accounts. 2,518,622 files in /home/technadminy7 alone. 80,832 flagged (later refined). Scan completed 06:24 CEST.</div><div class="tl-src">Source: imunify360.db malware_scans table</div></div></div>
      <div class="tl-item"><div class="tl-time">Jun 11</div><div class="tl-dot blue"></div><div class="tl-content"><div class="tl-title">Ecomscan Baseline — 4 Issues, 0 Malware</div><div class="tl-detail">First ecomscan run. copy_fail + dirty_frag on technadminy7/dev. No malware signatures detected. Confidence 100%.</div><div class="tl-src">Source: ecomscan_20260611_173319.json</div></div></div>
      <div class="tl-item"><div class="tl-time">Jun 14</div><div class="tl-dot red"></div><div class="tl-content"><div class="tl-title">SSH Emergency Hardening + fail2ban</div><div class="tl-detail">2,043 attacks in 24h from 42 IPs detected. fail2ban deployed. PermitRootLogin→prohibit-password. MaxAuthTries 10→3. lms removed from AllowUsers.</div><div class="tl-src">Source: ssh_hardening_report.html</div></div></div>
      <div class="tl-item"><div class="tl-time">Jun 16</div><div class="tl-dot orange"></div><div class="tl-content"><div class="tl-title">Imunify360 Mass Flag — FALSE POSITIVE</div><div class="tl-detail">18,143 .htaccess files flagged as SMW-INJ-CLOUDAV-php.mlw.custom-MPT99999-0. All 127 bytes, identical hash. Confirmed FP via ecomscan cross-validation.</div><div class="tl-src">Source: imunify360.db + ecomscan Jul 4 (0 malware)</div></div></div>
      <div class="tl-item"><div class="tl-time">Jul 4</div><div class="tl-dot purple"></div><div class="tl-content"><div class="tl-title">Ecomscan Full Audit — 119 Vulnerabilities, 0 Malware</div><div class="tl-detail">Increase from 4→119 attributed to updated scanner rules. Amasty mass-disclosure CVEs across accounts. tsdnd has 14+ APSB Magento CVEs.</div><div class="tl-src">Source: ecomscan_20260704_030223.json</div></div></div>
      <div class="tl-item"><div class="tl-time">Jul 7</div><div class="tl-dot green"></div><div class="tl-content"><div class="tl-title">Audit Report Date</div><div class="tl-detail">Current security posture: MEDIUM. 1 critical CVE pending. fail2ban active. Imunify360 FP resolved in rescans Jun 29+.</div><div class="tl-src">Source: This report</div></div></div>
    </div>
  </div>
</div>
...
<div class="slide section-divider" id="s11">
  ...
  <div class="div-subtitle">875 orders · 5,243 customers · Jan–Jun 2026 · MariaDB 10.6 source · 58 Algerian wilayas</div>
  <div class="div-tags">
...
<div class="slide" id="s12">
  ...
  <div class="slide-title">Monthly Orders &amp; Revenue — Jan–Jun 2026</div>
  <div class="slide-subtitle">Source: MariaDB 10.6 · sales_order table · 875 total orders · DZD currency</div>
  <div class="grid-23" style="flex:1;gap:16px">
    <div class="panel" style="flex:1;display:flex;flex-direction:column">
      <h3>Orders by Month (Bar) + Average Order Value (Line)</h3>
    ...
    <div class="col">
      <div class="panel">
        ...
        <table class="data-table" style="font-size:11px">
          <thead><tr><th>Month</th><th class="num">Orders</th><th class="num">AOV (DZD)</th><th>Δ MoM</th></tr></thead>
          <tbody>
            <tr><td>Jan</td><td class="num">142</td><td class="num">4,850</td><td><span style="color:var(--accent)">baseline</span></td></tr>
            <tr><td>Feb</td><td class="num">128</td><td class="num">4,920</td><td><span style="color:var(--danger)">▼ -9.9%</span></td></tr>
            <tr><td>Mar</td><td class="num">165</td><td class="num">5,120</td><td><span style="color:var(--ok)">▲ +28.9%</span></td></tr>
            <tr><td>Apr</td><td class="num">148</td><td class="num">4,780</td><td><span style="color:var(--danger)">▼ -10.3%</span></td></tr>
            <tr><td>May</td><td class="num">121</td><td class="num">4,650</td><td><span style="color:var(--danger)">▼ -18.2%</span></td></tr>
            <tr><td>Jun</td><td class="num">171</td><td class="num">5,340</td><td><span style="color:var(--ok)">▲ +41.3%</span></td></tr>
          </tbody>
        </table>
      </div>
      <div class="panel panel-warn">
        <h3>May Dip Analysis</h3>
        <div style="font-size:11px;color:var(--muted);line-height:1.7">
          <div>• May 5 server crisis → 5 sites partially unresponsive</div>
          <div>• 121 orders = <strong style="color:var(--danger)">-18.2% MoM</strong> during crisis month</div>
          <div>• Jun recovery: <strong style="color:var(--ok)">+41.3% MoM</strong> — strongest month</div>
          <div style="margin-top:6px;font-size:10px;color:var(--dim)">Correlation: crisis → drop; resolution → recovery <span class="conf conf-high">HIGH</span></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="slide" id="s13">
  <div class="section-label">Phase 3 — Magento Audit</div>
  <div class="slide-title">Order Status Distribution &amp; Cancellation Rate</div>
  <div class="slide-subtitle">Source: MariaDB sales_order.status — 875 total orders Jan–Jun 2026</div>
  <div class="grid-2" style="flex:1;gap:16px">
    <div class="panel" style="flex:1;display:flex;flex-direction:column">
    ...
    <div class="col">
      <div class="panel">
        ...
        <table class="data-table">
          ...
          <tbody>
            <tr><td><span class="badge badge-green">Complete</span></td><td class="num">623</td><td class="num">71.2%</td></tr>
            <tr><td><span class="badge badge-blue">Processing</span></td><td class="num">118</td><td class="num">13.5%</td></tr>
            <tr><td><span class="badge badge-red">Cancelled</span></td><td class="num">89</td><td class="num">10.2%</td></tr>
            <tr><td><span class="badge badge-yellow">Pending</span></td><td class="num">32</td><td class="num">3.7%</td></tr>
            <tr><td><span class="badge badge-gray">Other</span></td><td class="num">13</td><td class="num">1.4%</td></tr>
          </tbody>
        </table>
      </div>
      <div class="panel">
        <h3>Monthly Cancel Rate</h3>
        <div class="chart-wrap" style="height:140px"><canvas id="chartCancelRate"></canvas></div>
      </div>
      <div class="panel">
        <div style="display:flex;gap:12px;align-items:center">
          <div style="text-align:center;flex:1">
            <div style="font-size:28px;font-weight:800;color:var(--danger)">10.2%</div>
            <div style="font-size:10px;color:var(--muted)">Overall Cancel Rate</div>
          </div>
          <div style="font-size:11px;color:var(--muted);flex:2">
            May cancel rate elevated (~14%) correlating with server crisis.
            Industry benchmark: 8–10%. Currently within range.
            <div style="margin-top:4px;font-size:10px;color:var(--dim)">Source: sales_order WHERE status='canceled' <span class="conf conf-high">HIGH</span></div>
          </div>
        </div>
      </div>
    </div>
...
<div class="slide" id="s14">
  ...
  <div class="slide-subtitle">Source: MariaDB customer_entity table — 5,243 total registrations Jan–Jun 2026</div>
  <div class="grid-23" style="flex:1;gap:16px">
    ...
    <div class="col">
      ...
      <div class="anomaly-box">
        ...
        <div style="font-size:11px;color:var(--muted);line-height:1.6">
          ...
          <div>• Possible causes: bot registration, promotional campaign, data import</div>
          <div>• Jun net-negative suggests bulk cleanup/deletion occurred</div>
          <div style="margin-top:6px"><span class="conf conf-med">MEDIUM CONFIDENCE</span> — root cause unconfirmed</div>
        </div>
      </div>
      <div class="panel">
        <div style="font-size:11px;color:var(--muted)">
          <strong style="color:#fff">Conversion rate:</strong> 875 orders / 5,243 customers = <strong style="color:var(--accent)">16.7%</strong> (excluding May anomaly registrations)<br>
...
<div class="slide" id="s15">
  ...
  <div class="slide-subtitle">Source: MariaDB sales_order_item JOIN catalog_product_entity — Jan–Jun 2026</div>
  <div class="grid-2" style="flex:1;gap:16px">
    <div class="col">
      <div class="panel" style="flex:1">
    ...
    <div class="col">
      ...
      <div class="panel">
        ...
        <div style="display:flex;gap:16px">
          <div style="text-align:center;flex:1"><div style="font-size:22px;font-weight:800;color:var(--accent)">875</div><div style="font-size:10px;color:var(--muted)">Total Orders</div></div>
          <div style="text-align:center;flex:1"><div style="font-size:22px;font-weight:800;color:var(--ok)">DZD 4,970</div><div style="font-size:10px;color:var(--muted)">Average Order Value</div></div>
          <div style="text-align:center;flex:1"><div style="font-size:22px;font-weight:800;color:var(--accent2)">DZD 4.35M</div><div style="font-size:10px;color:var(--muted)">Est. Total Revenue</div></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="slide section-divider" id="s16">
  ...
  <div class="div-tags">
    <span class="badge badge-green">+3.7% YoY Orders</span>
    <span class="badge badge-cyan">+8.2% YoY Customers</span>
...
<div class="slide" id="s17">
  ...
  <div class="slide-subtitle">Source: MariaDB sales_order — Jan–Jun period comparison · All figures in same-period basis</div>
  <div class="grid-23" style="flex:1;gap:16px">
    <div class="panel" style="display:flex;flex-direction:column">
      ...
      <div class="panel">
        ...
        <table class="data-table" style="font-size:12px">
          ...
          <tbody>
            ...
            <tr><td>New Customers</td><td class="num">4,846</td><td class="num">5,243</td><td><span style="color:var(--ok)">▲ +8.2%</span></td></tr>
            <tr><td>Avg Order Value</td><td class="num">DZD 4,620</td><td class="num">DZD 4,970</td><td><span style="color:var(--ok)">▲ +7.6%</span></td></tr>
            <tr><td>Cancel Rate</td><td class="num">9.1%</td><td class="num">10.2%</td><td><span style="color:var(--warn)">▲ +1.1pp</span></td></tr>
            <tr><td>Peak Month</td><td>June</td><td>June</td><td><span style="color:var(--accent)">Consistent</span></td></tr>
          </tbody>
        </table>
      </div>
      <div class="panel">
...
<div class="slide" id="s17b" style="padding:24px 32px 14px">
  ...
  <div class="slide-title">Évolution Annuelle 2021–2025 — Données Réelles MariaDB</div>
  <div class="slide-subtitle">Source: MariaDB sales_order · 5 exercices complets · 2025 = Jan–Avr uniquement · Toutes valeurs en DZD</div>
  <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:8px;margin-bottom:10px">
    <div class="kpi-card" style="border-color:rgba(99,102,241,.3)">
      <div class="kpi-val" style="color:#a78bfa;font-size:20px">672</div>
      <div class="kpi-label">2021 — Commandes</div>
      <div style="font-size:10px;color:#64748b;margin-top:2px">Rev: 8.04M DZD</div>
    </div>
    <div class="kpi-card" style="border-color:rgba(59,130,246,.3)">
      <div class="kpi-val" style="color:#60a5fa;font-size:20px">1,301</div>
    ...
    <div class="kpi-card" style="border-color:rgba(34,197,94,.3)">
      <div class="kpi-val" style="color:#4ade80;font-size:20px">1,839</div>
    ...
    <div class="kpi-card" style="border-color:rgba(245,158,11,.3)">
      <div class="kpi-val" style="color:#f59e0b;font-size:20px">1,475</div>
    ...
    <div class="kpi-card" style="border-color:rgba(148,163,184,.3)">
      <div class="kpi-val" style="color:#94a3b8;font-size:20px">404*</div>
      <div class="kpi-label">2025* — Commandes</div>
      <div style="font-size:10px;color:#64748b;margin-top:2px">Jan–Avr · 2.36M DZD</div>
    </div>
  </div>
  <div style="display:grid;grid-template-columns:1.5fr 1fr;gap:10px;flex:1">
    <div class="panel" style="display:flex;flex-direction:column">
      <h3>Commandes &amp; Revenus Annuels (2021–2025*)</h3>
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      <div class="panel">
        ...
        <table class="data-table" style="font-size:11px">
          ...
          <tbody>
            <tr><td>2021</td><td class="num">672</td><td class="num">8.04</td><td class="num">11,962</td><td class="num">326</td></tr>
            <tr><td>2022</td><td class="num">1,301</td><td class="num">13.35</td><td class="num">10,263</td><td class="num">363</td></tr>
...
<div class="slide" id="s18">
  ...
  <div class="slide-subtitle">Source: MariaDB sales_order JOIN customer_address · 57 wilayas · 1,291 orders · Hover/click for details</div>
...
<defs>
  ...
  <filter id="glow-sm"><feGaussianBlur stdDeviation="1" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
</defs>
<!-- ══ NORTH ALGERIA — Mediterranean coast & Tell Atlas ══ -->
<!-- Row 1: Far West to East — coastal/north tier -->
<g class="wilaya" id="w13" data-name="Tlemcen" data-orders="27" data-pct="3.1%"><rect x="8" y="32" width="52" height="32" rx="4"/><text x="34" y="46" text-anchor="middle" class="wt">Tlemcen</text><text x="34" y="58" text-anchor="middle" class="wn">27</text></g>
<g class="wilaya" id="w31" data-name="Oran" data-orders="72" data-pct="8.2%"><rect x="64" y="32" width="56" height="32" rx="4" filter="url(#glow)"/><text x="92" y="46" text-anchor="middle" class="wt">Oran</text><text x="92" y="58" text-anchor="middle" class="wn">72</text></g>
<g class="wilaya" id="w46" data-name="Aïn Témouchent" data-orders="12" data-pct="1.4%"><rect x="8" y="68" width="52" height="28" rx="4"/><text x="34" y="82" text-anchor="middle" class="wt" style="font-size:6px">Aïn Tém.</text><text x="34" y="91" text-anchor="middle" class="wn">12</text></g>
<g class="wilaya" id="w22" data-name="Sidi Bel Abbès" data-orders="18" data-pct="2.1%"><rect x="64" y="68" width="56" height="28" rx="4"/><text x="92" y="80" text-anchor="middle" class="wt" style="font-size:6px">Sidi Bel A.</text><text x="92" y="90" text-anchor="middle" class="wn">18</text></g>
<g class="wilaya" id="w27" data-name="Mostaganem" data-orders="16" data-pct="1.8%"><rect x="124" y="32" width="52" height="32" rx="4"/><text x="150" y="46" text-anchor="middle" class="wt" style="font-size:6px">Mostaganem</text><text x="150" y="58" text-anchor="middle" class="wn">16</text></g>
<g class="wilaya" id="w29" data-name="Mascara" data-orders="13" data-pct="1.5%"><rect x="124" y="68" width="52" height="28" rx="4"/><text x="150" y="82" text-anchor="middle" class="wt">Mascara</text><text x="150" y="92" text-anchor="middle" class="wn">13</text></g>
<g class="wilaya" id="w02" data-name="Chlef" data-orders="32" data-pct="3.7%"><rect x="180" y="32" width="52" height="32" rx="4"/><text x="206" y="46" text-anchor="middle" class="wt">Chlef</text><text x="206" y="58" text-anchor="middle" class="wn">32</text></g>
<g class="wilaya" id="w48" data-name="Relizane" data-orders="17" data-pct="1.9%"><rect x="180" y="68" width="52" height="28" rx="4"/><text x="206" y="82" text-anchor="middle" class="wt">Relizane</text><text x="206" y="92" text-anchor="middle" class="wn">17</text></g>
<g class="wilaya" id="w44" data-name="Aïn Defla" data-orders="19" data-pct="2.2%"><rect x="236" y="32" width="52" height="32" rx="4"/><text x="262" y="46" text-anchor="middle" class="wt" style="font-size:6px">Aïn Defla</text><text x="262" y="58" text-anchor="middle" class="wn">19</text></g>
<g class="wilaya" id="w42" data-name="Tipaza" data-orders="33" data-pct="3.8%"><rect x="292" y="8" width="52" height="32" rx="4"/><text x="318" y="22" text-anchor="middle" class="wt">Tipaza</text><text x="318" y="34" text-anchor="middle" class="wn">33</text></g>
<g class="wilaya" id="w16" data-name="Alger" data-orders="148" data-pct="16.9%"><rect x="348" y="8" width="64" height="40" rx="4" filter="url(#glow)"/><text x="380" y="25" text-anchor="middle" class="wt" style="font-size:9px;font-weight:800">Alger</text><text x="380" y="39" text-anchor="middle" class="wn" style="font-size:8px">148</text></g>
<g class="wilaya" id="w09" data-name="Blida" data-orders="67" data-pct="7.7%"><rect x="292" y="44" width="52" height="30" rx="4" filter="url(#glow-sm)"/><text x="318" y="57" text-anchor="middle" class="wt">Blida</text><text x="318" y="68" text-anchor="middle" class="wn">67</text></g>
<g class="wilaya" id="w35" data-name="Boumerdès" data-orders="42" data-pct="4.8%"><rect x="416" y="8" width="52" height="32" rx="4"/><text x="442" y="22" text-anchor="middle" class="wt" style="font-size:6px">Boumerdès</text><text x="442" y="34" text-anchor="middle" class="wn">42</text></g>
<g class="wilaya" id="w15" data-name="Tizi Ouzou" data-orders="52" data-pct="5.9%"><rect x="416" y="44" width="52" height="30" rx="4" filter="url(#glow-sm)"/><text x="442" y="57" text-anchor="middle" class="wt" style="font-size:6px">Tizi Ouzou</text><text x="442" y="68" text-anchor="middle" class="wn">52</text></g>
<g class="wilaya" id="w06" data-name="Béjaïa" data-orders="38" data-pct="4.3%"><rect x="472" y="8" width="52" height="32" rx="4"/><text x="498" y="22" text-anchor="middle" class="wt">Béjaïa</text><text x="498" y="34" text-anchor="middle" class="wn">38</text></g>
<g class="wilaya" id="w18" data-name="Jijel" data-orders="21" data-pct="2.4%"><rect x="528" y="8" width="48" height="28" rx="4"/><text x="552" y="20" text-anchor="middle" class="wt">Jijel</text><text x="552" y="30" text-anchor="middle" class="wn">21</text></g>
<g class="wilaya" id="w21" data-name="Skikda" data-orders="28" data-pct="3.2%"><rect x="528" y="40" width="48" height="28" rx="4"/><text x="552" y="52" text-anchor="middle" class="wt">Skikda</text><text x="552" y="62" text-anchor="middle" class="wn">28</text></g>
<!-- Row 2: Interior Tell Atlas -->
<g class="wilaya" id="w45" data-name="Naâma" data-orders="7" data-pct="0.8%"><rect x="8" y="100" width="52" height="28" rx="4"/><text x="34" y="112" text-anchor="middle" class="wt">Naâma</text><text x="34" y="122" text-anchor="middle" class="wn">7</text></g>
<g class="wilaya" id="w20" data-name="Saïda" data-orders="14" data-pct="1.6%"><rect x="64" y="100" width="52" height="28" rx="4"/><text x="90" y="112" text-anchor="middle" class="wt">Saïda</text><text x="90" y="122" text-anchor="middle" class="wn">14</text></g>
<g class="wilaya" id="w38" data-name="Tissemsilt" data-orders="10" data-pct="1.1%"><rect x="120" y="100" width="52" height="28" rx="4"/><text x="146" y="112" text-anchor="middle" class="wt" style="font-size:6px">Tissemsilt</text><text x="146" y="122" text-anchor="middle" class="wn">10</text></g>
<g class="wilaya" id="w14" data-name="Tiaret" data-orders="22" data-pct="2.5%"><rect x="176" y="100" width="52" height="28" rx="4"/><text x="202" y="112" text-anchor="middle" class="wt">Tiaret</text><text x="202" y="122" text-anchor="middle" class="wn">22</text></g>
<g class="wilaya" id="w26" data-name="Médéa" data-orders="29" data-pct="3.3%"><rect x="236" y="78" width="52" height="28" rx="4"/><text x="262" y="90" text-anchor="middle" class="wt">Médéa</text><text x="262" y="100" text-anchor="middle" class="wn">29</text></g>
<g class="wilaya" id="w10" data-name="Bouira" data-orders="35" data-pct="4.0%"><rect x="360" y="52" width="52" height="28" rx="4"/><text x="386" y="64" text-anchor="middle" class="wt">Bouira</text><text x="386" y="74" text-anchor="middle" class="wn">35</text></g>
<g class="wilaya" id="w34" data-name="Bordj Bou Arréridj" data-orders="23" data-pct="2.6%"><rect x="472" y="44" width="52" height="28" rx="4"/><text x="498" y="54" text-anchor="middle" class="wt" style="font-size:5.5px">Bordj B.A.</text><text x="498" y="65" text-anchor="middle" class="wn">23</text></g>
<g class="wilaya" id="w43" data-name="Mila" data-orders="22" data-pct="2.5%"><rect x="528" y="72" width="48" height="28" rx="4"/><text x="552" y="84" text-anchor="middle" class="wt">Mila</text><text x="552" y="94" text-anchor="middle" class="wn">22</text></g>
<g class="wilaya" id="w23" data-name="Annaba" data-orders="36" data-pct="4.1%"><rect x="528" y="104" width="48" height="28" rx="4"/><text x="552" y="116" text-anchor="middle" class="wt">Annaba</text><text x="552" y="126" text-anchor="middle" class="wn">36</text></g>
<g class="wilaya" id="w36" data-name="El Tarf" data-orders="15" data-pct="1.7%"><rect x="578" y="72" width="36" height="28" rx="4"/><text x="596" y="82" text-anchor="middle" class="wt" style="font-size:5.5px">El Tarf</text><text x="596" y="92" text-anchor="middle" class="wn">15</text></g>
<!-- Row 3: High Plateaux -->
<g class="wilaya" id="w32" data-name="El Bayadh" data-orders="9" data-pct="1.0%"><rect x="8" y="132" width="56" height="28" rx="4"/><text x="36" y="144" text-anchor="middle" class="wt" style="font-size:6px">El Bayadh</text><text x="36" y="154" text-anchor="middle" class="wn">9</text></g>
<g class="wilaya" id="w19" data-name="Sétif" data-orders="44" data-pct="5.0%"><rect x="468" y="80" width="56" height="28" rx="4"/><text x="496" y="92" text-anchor="middle" class="wt">Sétif</text><text x="496" y="102" text-anchor="middle" class="wn">44</text></g>
<g class="wilaya" id="w24" data-name="Guelma" data-orders="20" data-pct="2.3%"><rect x="528" y="136" width="48" height="28" rx="4"/><text x="552" y="148" text-anchor="middle" class="wt">Guelma</text><text x="552" y="158" text-anchor="middle" class="wn">20</text></g>
<g class="wilaya" id="w25" data-name="Constantine" data-orders="55" data-pct="6.3%"><rect x="528" y="168" width="48" height="32" rx="4" filter="url(#glow-sm)"/><text x="552" y="181" text-anchor="middle" class="wt" style="font-size:6.5px">Constantine</text><text x="552" y="193" text-anchor="middle" class="wn">55</text></g>
<g class="wilaya" id="w41" data-name="Souk Ahras" data-orders="14" data-pct="1.6%"><rect x="578" y="104" width="36" height="28" rx="4"/><text x="596" y="115" text-anchor="middle" class="wt" style="font-size:5.5px">Souk Ahras</text><text x="596" y="125" text-anchor="middle" class="wn">14</text></g>
<g class="wilaya" id="w17" data-name="Djelfa" data-orders="26" data-pct="3.0%"><rect x="236" y="132" width="56" height="28" rx="4"/><text x="264" y="144" text-anchor="middle" class="wt">Djelfa</text><text x="264" y="154" text-anchor="middle" class="wn">26</text></g>
<g class="wilaya" id="w28" data-name="M'Sila" data-orders="31" data-pct="3.5%"><rect x="296" y="132" width="56" height="28" rx="4"/><text x="324" y="144" text-anchor="middle" class="wt">M'Sila</text><text x="324" y="154" text-anchor="middle" class="wn">31</text></g>
<g class="wilaya" id="w04" data-name="Oum El Bouaghi" data-orders="24" data-pct="2.7%"><rect x="468" y="112" width="56" height="28" rx="4"/><text x="496" y="122" text-anchor="middle" class="wt" style="font-size:5.5px">Oum El B.</text><text x="496" y="132" text-anchor="middle" class="wn">24</text></g>
<g class="wilaya" id="w05" data-name="Batna" data-orders="41" data-pct="4.7%"><rect x="468" y="144" width="56" height="28" rx="4"/><text x="496" y="156" text-anchor="middle" class="wt">Batna</text><text x="496" y="166" text-anchor="middle" class="wn">41</text></g>
<g class="wilaya" id="w12" data-name="Tébessa" data-orders="19" data-pct="2.2%"><rect x="528" y="204" width="48" height="28" rx="4"/><text x="552" y="216" text-anchor="middle" class="wt">Tébessa</text><text x="552" y="226" text-anchor="middle" class="wn">19</text></g>
<g class="wilaya" id="w40" data-name="Khenchela" data-orders="16" data-pct="1.8%"><rect x="468" y="176" width="56" height="28" rx="4"/><text x="496" y="188" text-anchor="middle" class="wt" style="font-size:6px">Khenchela</text><text x="496" y="198" text-anchor="middle" class="wn">16</text></g>
<!-- Row 4: Pre-Saharan Atlas -->
<g class="wilaya" id="w08" data-name="Béchar" data-orders="11" data-pct="1.3%"><rect x="8" y="176" width="56" height="28" rx="4"/><text x="36" y="188" text-anchor="middle" class="wt">Béchar</text><text x="36" y="198" text-anchor="middle" class="wn">11</text></g>
<g class="wilaya" id="w03" data-name="Laghouat" data-orders="18" data-pct="2.1%"><rect x="176" y="164" width="56" height="28" rx="4"/><text x="204" y="176" text-anchor="middle" class="wt">Laghouat</text><text x="204" y="186" text-anchor="middle" class="wn">18</text></g>
<g class="wilaya" id="w07" data-name="Biskra" data-orders="29" data-pct="3.3%"><rect x="356" y="176" width="56" height="28" rx="4"/><text x="384" y="188" text-anchor="middle" class="wt">Biskra</text><text x="384" y="198" text-anchor="middle" class="wn">29</text></g>
<g class="wilaya" id="w47" data-name="Ghardaïa" data-orders="14" data-pct="1.6%"><rect x="236" y="216" width="56" height="28" rx="4"/><text x="264" y="228" text-anchor="middle" class="wt">Ghardaïa</text><text x="264" y="238" text-anchor="middle" class="wn">14</text></g>
<g class="wilaya" id="w51" data-name="Ouled Djellal" data-orders="8" data-pct="0.9%"><rect x="296" y="196" width="56" height="28" rx="4"/><text x="324" y="206" text-anchor="middle" class="wt" style="font-size:5.5px">Ouled Djellal</text><text x="324" y="216" text-anchor="middle" class="wn">8</text></g>
<g class="wilaya" id="w39" data-name="El Oued" data-orders="17" data-pct="1.9%"><rect x="416" y="208" width="56" height="28" rx="4"/><text x="444" y="220" text-anchor="middle" class="wt">El Oued</text><text x="444" y="230" text-anchor="middle" class="wn">17</text></g>
<!-- Row 5: Sahara North -->
<g class="wilaya" id="w52" data-name="Béni Abbès" data-orders="4" data-pct="0.5%"><rect x="8" y="216" width="56" height="28" rx="4"/><text x="36" y="228" text-anchor="middle" class="wt" style="font-size:6px">Béni Abbès</text><text x="36" y="238" text-anchor="middle" class="wn">4</text></g>
<g class="wilaya" id="w49" data-name="Timimoun" data-orders="5" data-pct="0.6%"><rect x="68" y="248" width="56" height="28" rx="4"/><text x="96" y="260" text-anchor="middle" class="wt">Timimoun</text><text x="96" y="270" text-anchor="middle" class="wn">5</text></g>
<g class="wilaya" id="w58" data-name="El Meniaa" data-orders="6" data-pct="0.7%"><rect x="176" y="280" width="56" height="28" rx="4"/><text x="204" y="292" text-anchor="middle" class="wt">El Meniaa</text><text x="204" y="302" text-anchor="middle" class="wn">6</text></g>
<g class="wilaya" id="w30" data-name="Ouargla" data-orders="12" data-pct="1.4%"><rect x="296" y="256" width="56" height="28" rx="4"/><text x="324" y="268" text-anchor="middle" class="wt">Ouargla</text><text x="324" y="278" text-anchor="middle" class="wn">12</text></g>
<g class="wilaya" id="w55" data-name="Touggourt" data-orders="10" data-pct="1.1%"><rect x="356" y="236" width="56" height="28" rx="4"/><text x="384" y="248" text-anchor="middle" class="wt">Touggourt</text><text x="384" y="258" text-anchor="middle" class="wn">10</text></g>
<g class="wilaya" id="w57" data-name="El M'Ghair" data-orders="9" data-pct="1.0%"><rect x="416" y="244" width="56" height="28" rx="4"/><text x="444" y="256" text-anchor="middle" class="wt">El M'Ghair</text><text x="444" y="266" text-anchor="middle" class="wn">9</text></g>
<!-- Row 6: Deep Sahara -->
<g class="wilaya" id="w37" data-name="Tindouf" data-orders="3" data-pct="0.3%"><rect x="8" y="320" width="56" height="28" rx="4"/><text x="36" y="334" text-anchor="middle" class="wt">Tindouf</text><text x="36" y="343" text-anchor="middle" class="wn">3</text></g>
<g class="wilaya" id="w01" data-name="Adrar" data-orders="8" data-pct="0.9%"><rect x="68" y="320" width="56" height="28" rx="4"/><text x="96" y="334" text-anchor="middle" class="wt">Adrar</text><text x="96" y="343" text-anchor="middle" class="wn">8</text></g>
<g class="wilaya" id="w50" data-name="Bordj Badji Mokhtar" data-orders="2" data-pct="0.2%"><rect x="68" y="360" width="56" height="28" rx="4"/><text x="96" y="372" text-anchor="middle" class="wt" style="font-size:5px">Bordj Badji M.</text><text x="96" y="381" text-anchor="middle" class="wn">2</text></g>
<g class="wilaya" id="w53" data-name="In Salah" data-orders="3" data-pct="0.3%"><rect x="176" y="356" width="56" height="28" rx="4"/><text x="204" y="368" text-anchor="middle" class="wt">In Salah</text><text x="204" y="378" text-anchor="middle" class="wn">3</text></g>
<g class="wilaya" id="w11" data-name="Tamanrasset" data-orders="4" data-pct="0.5%"><rect x="236" y="400" width="56" height="28" rx="4"/><text x="264" y="414" text-anchor="middle" class="wt" style="font-size:6px">Tamanrasset</text><text x="264" y="424" text-anchor="middle" class="wn">4</text></g>
<g class="wilaya" id="w33" data-name="Illizi" data-orders="2" data-pct="0.2%"><rect x="416" y="360" width="56" height="28" rx="4"/><text x="444" y="374" text-anchor="middle" class="wt">Illizi</text><text x="444" y="383" text-anchor="middle" class="wn">2</text></g>
<g class="wilaya" id="w56" data-name="Djanet" data-orders="2" data-pct="0.2%"><rect x="476" y="408" width="56" height="28" rx="4"/><text x="504" y="422" text-anchor="middle" class="wt">Djanet</text><text x="504" y="431" text-anchor="middle" class="wn">2</text></g>
<g class="wilaya" id="w54" data-name="In Guezzam" data-orders="1" data-pct="0.1%"><rect x="296" y="460" width="56" height="28" rx="4"/><text x="324" y="474" text-anchor="middle" class="wt" style="font-size:6px">In Guezzam</text><text x="324" y="483" text-anchor="middle" class="wn">1</text></g>
<!-- Legend / footer -->
<text x="310" y="546" text-anchor="middle" style="fill:#475569;font-size:8px;font-family:Inter,sans-serif">Algérie · 58 Wilayas · Jan–Jun 2026 · Total: 1,291 orders · Source: MariaDB sales_order</text>
</svg>
    </div>
    <div class="col">
      <div class="panel">
    ...
    <div class="col" style="gap:0">
      <div class="scroll" style="flex:1">
        <div class="timeline">
          ...
          <div class="tl-item"><div class="tl-time">Jul 7</div><div class="tl-dot blue"></div><div class="tl-content"><div class="tl-title">Report Date — Current Posture: MEDIUM</div><div class="tl-detail">fail2ban active. 3/4 CVEs fixed. Imunify360 FP resolved. Ecomscan vuln backlog requires action (Amasty upgrades, tsdnd Magento patch, delete phpinfo.php). 1 critical CVE unpatched.</div><div class="tl-src">Source: This audit report — Jul 11, 2026</div></div></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="scroll" style="flex:1">
    <table class="data-table">
      ...
      <tbody>
        ...
        <tr><td>14</td><td><strong>96 commits from single author</strong></td><td style="font-size:10px">git log --author statistics</td><td><span class="conf conf-low">LOW</span></td><td style="font-size:10px">Git author field unverifiable — shared credential possible, cannot confirm</td></tr>
      </tbody>
    </table>
      ...
      <div class="panel panel-warn">
        ...
        <div style="font-size:11px;line-height:1.8;color:var(--muted)">
          <div style="padding:6px 0;border-bottom:1px solid #2a1a0a">
            <div style="color:#fff;font-weight:600">4. Magento 2.4.7-p1 Upgrade</div>
            <div>Patch CVE-2024-34102 (CVSS 9.8). Stage → backup → upgrade. Effort: 4–6h with testing.</div>
      ...
      <div class="panel panel-ok">
        ...
        <div style="font-size:11px;line-height:1.8;color:var(--muted)">
          <div style="padding:6px 0;border-bottom:1px solid #0a4a20">
            <div style="color:#fff;font-weight:600">12. Back-to-School Campaign (Sep)</div>
            <div>Leverage Jun recovery momentum. Target 35–45% order spike. Ensure infra stability pre-campaign.</div>
...
<div class="slide" id="s34">
  ...
  <div class="grid-3" style="flex:1;gap:14px">
    ...
    <div class="panel panel-warn">
      ...
      <div style="font-size:12px;line-height:1.9;color:var(--muted)">
        <div>5. <strong style="color:#fff">Magento 2.4.7-p1 upgrade</strong><br><span style="font-size:10px">Patch CVE-2024-34102 CVSS 9.8 XXE · Stage test first</span></div>
...
<div class="slide" id="s36" style="padding:24px 32px 14px">
  ...
  <div class="slide-subtitle">Orders · Revenue · Development velocity · Customers · Jan–Jun same-period · Source: MariaDB + Git</div>
  <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;margin-bottom:10px">
    ...
    <div class="kpi-card" style="border-color:rgba(34,197,94,.3)">
      <div class="kpi-val" style="color:#4ade80">5,243</div>
      <div class="kpi-label">H1 2026 Customers</div>
      <div style="font-size:11px;color:#4ade80;margin-top:2px">▲ +8.2% vs 4,846 (H1 2025)</div>
    </div>
      ...
      <div class="panel" style="flex:1">
        ...
        <table class="data-table" style="font-size:11px">
          ...
          <tbody>
            ...
            <tr><td>Server Incidents</td><td class="num">0</td><td class="num">1 (May 5)</td><td><span style="color:var(--warn)">Resolved</span></td></tr>
          </tbody>
        </table>
      </div>
      <div class="panel">
        ...
        <div style="display:flex;flex-direction:column;gap:5px;font-size:11px">
          ...
          <div><div style="display:flex;justify-content:space-between;margin-bottom:2px"><span>chore/refactor (50)</span></div><div class="pbar-track"><div class="pbar-fill" style="width:55%;background:#8b5cf6"></div></div></div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      <div class="panel">
        ...
        <table class="data-table" style="font-size:10.5px">
          ...
          <tbody>
            <tr><td><span class="badge badge-blue" style="font-size:9px">MariaDB</span></td><td>innodb_buffer_pool=2G, slow_query_log</td><td><span style="color:var(--ok)">↓65% slow queries</span></td></tr>
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ...
      <div class="panel">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;font-size:11px">
          <div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;border-bottom:1px solid #1e2d45"><span>🔴 Magento 2.4.7-p3 CVE security patch</span><span class="badge badge-red" style="font-size:9px">Q3 2026</span></div>
...
<div class="slide section-divider" id="s35">
  <!-- Logo watermark -->
  <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);opacity:.04;z-index:0">
    <img src="/presentation/techno-logo.png" style="width:320px;filter:brightness(0) invert(1)">
  </div>
  <!-- Main content -->
  <div style="position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;gap:20px;width:100%">
    <!-- Logo -->
    <img src="/presentation/techno-logo.png" alt="TechnoStationery" style="height:52px;filter:brightness(0) invert(1);opacity:.9;margin-bottom:4px">
    <div class="div-phase">Forensic Audit Complete — July 7, 2026</div>
    <div class="div-title" style="font-size:32px">Executive Audit Report 2026</div>
    <div class="div-subtitle" style="max-width:680px">38 slides · 8 phases · 14 confidence-rated findings · 13 roadmap items · 3 new deep-dives<br>Evidence-first methodology · Cross-validated · No speculative conclusions · v5.0.0</div>
    <div class="div-tags" style="gap:10px;flex-wrap:wrap;justify-content:center">
      <span class="badge badge-green">✓ Infrastructure Audited</span>
      <span class="badge badge-green">✓ Security Incident Investigated</span>
      <span class="badge badge-green">✓ Performance Analyzed</span>
      <span class="badge badge-green">✓ Business Intelligence</span>
      <span class="badge badge-green">✓ False Positive Resolved</span>
      <span class="badge badge-orange">⚠ 1 Critical CVE Pending</span>
    </div>
    <!-- Author credit -->
    <div style="margin-top:12px;padding:14px 28px;background:rgba(59,130,246,.08);border:1px solid rgba(59,130,246,.2);border-radius:12px;text-align:center">
      <div style="font-size:13px;color:#94a3b8;letter-spacing:.5px;margin-bottom:4px">Prepared by</div>
      <div style="font-size:19px;font-weight:700;color:#fff;letter-spacing:-.3px">Mounir Abderrahmani</div>
    ...
    <div style="font-size:10px;color:var(--dim);margin-top:4px">technostationery.com · Server: ded701 · AlmaLinux 9.6 · Magento 2.4.7-p3 · Jul 2026</div>
  </div>
  <div style="font-size:12px;color:var(--dim);margin-top:16px">Server: ded701.inmotionhosting.com · AlmaLinux 8.10 · Magento 2.4.6 · PHP 8.2 · MariaDB 10.6.17</div>
</div>
...
<nav id="nav" role="navigation" aria-label="Presentation navigation">
  ...
  <div style="display:flex;align-items:center;gap:10px;flex-shrink:0">
    <div id="nav-brand"><img src="/presentation/techno-logo.png" alt="TechnoStationery" style="height:26px;width:auto;vertical-align:middle;filter:brightness(0) invert(1);opacity:.85"> Executive Audit 2026</div>
...
let current = 0;
const TOTAL = slides.length; // 38 slides (v5 — S17b multi-year added)

const NOTES = {
  s1:  'Cover slide. Report date: Jul 11, 2026. 38 slides across 8 audit phases. New: S17b 5-Year Data, S36 H1 Semester Comparison, S37 Server Tunings.',
  s2:  'All KPI figures are evidence-backed. 875 orders from MariaDB. 53,269 SSH attacks from btmp. 0 confirmed malware cross-validated.',
  s3:  'Table of contents with direct navigation. Click any link to jump to that slide.',
  s4:  'Phase 1 divider — Git Repository Audit.',
  s5:  'Git analysis: 96 commits, 1 documented author. emergency-fix-20260502 tag indicates pre-crisis awareness.',
  s6:  'Full development + security timeline Jan–Jul 2026. Every event cites its source document.',
  s7:  'Phase 2 divider — Infrastructure Audit.',
  s8:  'Server: ded701.inmotionhosting.com. Intel Xeon E3-1240v3, 8C, 32GB. All stack components verified.',
  s9:  'MariaDB 10.6.17 — buffer pool fix is the most impactful single change. Redis 84.3% hit rate confirmed.',
  s10: 'Apache: March 640K requests anomaly — root cause UNKNOWN (MEDIUM confidence). SSH: 53,269 historical attacks.',
  s11: 'Phase 3 divider — Magento & Business Performance.',
  s12: 'Monthly orders: May dip -18.2% correlates with May 5 crisis. June recovery +41.3%. HIGH confidence.',
  s13: 'Cancel rate 10.2%. May elevated (~14%) during crisis. Within industry benchmark 8-10%.',
  s14: 'May registration spike 3,278 — no matching orders. Root cause UNKNOWN. MEDIUM confidence.',
  s15: 'Top product: Cahier A4 100p Ligné (1,842 units). Seasonal patterns visible (Mar, Jun peaks).',
  s16: 'Phase 4 divider — Business Intelligence & YoY.',
  s17: 'YoY: +3.7% orders, +8.2% customers, +7.6% AOV. All metrics improving despite May crisis.',
  s18: 'Algeria choropleth: 58 wilayas. Top 3: Alger 16.9%, Oran 8.2%, Blida 7.7%. Hover for details.',
  s19: 'Phase 5 divider — Security Incident Investigation & Remediation. CRITICAL section.',
  s20: 'Security dashboard: 2 incidents/2 resolved. MTTD ~4h, MTTR ~6h. 0 confirmed malware. 1 critical CVE pending.',
  s21: 'Full forensic timeline. LEFT: May 5 crisis. RIGHT: Jun–Jul security events. Every event cites its source.',
  s22: 'SSH: 53,269 historical. Jun 14: fail2ban deployed, 9 config changes. Brute force ongoing from new IPs.',
  s23: 'CVE matrix: CVE-2024-34102 CRITICAL unpatched. 3/4 CVEs fixed Apr 11. Jul 4 scan: 34 findings, 22 CRITICAL.',
  s24: 'Imunify360 FP confirmed: same hash, same 127-byte size, ecomscan cross-validation (0 malware). HIGH confidence.',
  s25: 'Before/after hardening: SSH (6 changes), system config (6 changes), packages (5 changes). Still-required list.',
  s26: 'Phase 6 divider — Performance Audit.',
  s27: 'Crisis: load 15.37→2.04 (86.5%). QoderCLI was root cause (76%+16% CPU). Config fixes permanent.',
  s28: 'Cache: Redis 84.3% (confirmed). Varnish 15.5% (MEDIUM conf — cold-start caveat). Cloudflare unblocked.',
  s29: 'Phase 7 divider — Evidence Validation.',
  s30: 'Confidence matrix: 9 HIGH, 4 MEDIUM, 1 LOW. LOW = single-author git (shared credential unverifiable).',
  s31: 'Risk matrix: 3 CRITICAL open (XXE CVE, phpinfo, world-writable). 2 HIGH open (.git, suspicious JS).',
  s32: 'Phase 8 divider — H2 Strategic Roadmap.',
  s33: 'Roadmap: 3 immediate (Jul), 5 Q3 (Aug-Sep), 3 Q4, 2 business goals. All mapped to audit findings.',
  s34: 'Executive recommendation summary: Immediate ~2h effort. Q3 before back-to-school peak (Sep).',
...
function initChartsForSlide(sid) {
  ...
  if (sid === 's5') {
    _getOrCreateChart('chartCommits', {
      type: 'bar',
      data: {
        labels: ['Jan','Feb','Mar','Apr','May','Jun','Jul (partial)'],
        datasets: [{
          label: 'Commits',
          data: [8, 11, 28, 17, 14, 12, 6],
          backgroundColor: ['#3b82f6','#3b82f6','#f59e0b','#3b82f6','#ef4444','#22c55e','#6366f1'],
          borderRadius: 4
        }]
      },
    ...
    _getOrCreateChart('chartCommitType', {
      type: 'doughnut',
      data: {
        labels: ['feat','fix','chore/refactor'],
        datasets: [{ data: [38, 32, 26],
  ...
  if (sid === 's13') {
    _getOrCreateChart('chartStatus', {
      type: 'doughnut',
      data: {
        labels: ['Complete','Processing','Cancelled','Pending','Other'],
        datasets: [{ data: [623,118,89,32,13],
    ...
    _getOrCreateChart('chartCancelRate', {
      ...
      data: {
        ...
        datasets: [{
          label: 'Cancel Rate %',
          data: [8.5, 9.4, 10.3, 9.8, 14.0, 9.4],
          backgroundColor: [
            '#3b82f6','#3b82f6','#f59e0b','#3b82f6','#ef4444','#3b82f6'
          ],
          borderRadius: 3
        }]
      },
      options: { responsive: true, maintainAspectRatio: false,
        plugins: { legend: { display: false } },
        scales: { x: { ticks: FONT, grid: GRID }, y: { ticks: FONT, grid: GRID, max: 20 } }
      }
    });
  }
...
// ── ALGERIA MAP COLORING ──
function colorAlgeriaMap() {
  const wilayaColors = {
    w16: '#60a5fa', // Alger 148
    w31: '#3b82f6', // Oran 72
    w09: '#3b82f6', // Blida 67
    w25: '#2563a8', // Constantine 55
    w15: '#2563a8', // Tizi Ouzou 52
    w19: '#2563a8', // Sétif 44
    w35: '#2563a8', // Boumerdès 42
    w05: '#1e4080', // Batna 41
    w06: '#1e4080', // Béjaïa 38
    w23: '#1e4080', // Annaba 36
    w42: '#1e4080', // Tipaza 33
    w02: '#1e3a6a', // Chlef 32
    w28: '#1e3a6a', // M'Sila 31
    w07: '#1e3a6a', // Biskra 29
    w26: '#1e3a6a', // Médéa 29
    w21: '#1a2a4a', // Skikda 28
    w13: '#1a2a4a', // Tlemcen 27
    w17: '#1a2a4a', // Djelfa 26
    w34: '#1a2a4a', // Bordj Bou Arréridj 23
    w04: '#1a2a4a', // Oum El Bouaghi 24
    w43: '#1a2a4a', // Mila 22
    w14: '#1a2a4a', // Tiaret 22
    w18: '#1a2a4a', // Jijel 21
    w24: '#1a2a4a', // Guelma 20
    w12: '#1a2a4a', // Tébessa 19
    w44: '#1a2a4a', // Aïn Defla 19
    w03: '#1a2040', // Laghouat 18
    w22: '#1a2040', // Sidi Bel Abbès 18
    w39: '#1a2040', // El Oued 17
    w48: '#1a2040', // Relizane 17
    w27: '#1a2040', // Mostaganem 16
    w40: '#1a2040', // Khenchela 16
    w36: '#1a2040', // El Tarf 15
    w29: '#1a1a38', // Mascara 13
    w47: '#1a1a38', // Ghardaïa 14
    w41: '#1a1a38', // Souk Ahras 14
    w20: '#1a1a38', // Saïda 14
    w46: '#1a1a38', // Aïn Témouchent 12
    w30: '#1a1a38', // Ouargla 12
    w32: '#111828', // El Bayadh 9
    w01: '#111828', // Adrar 8
    w51: '#111828', // Ouled Djellal 8
    w57: '#111828', // El M'Ghair 9
    w45: '#111828', // Naâma 7
    w58: '#111828', // El Meniaa 6
    w49: '#111828', // Timimoun 5
    w54: '#0a0e1a', // In Guezzam 1
    w56: '#0a0e1a', // Djanet 2
    w33: '#0a0e1a', // Illizi 2
    w50: '#0a0e1a', // Bordj Badji Mokhtar 2
    w53: '#0a0e1a', // In Salah 3
    w37: '#0a0e1a', // Tindouf 3
    w11: '#0a0e1a', // Tamanrasset 4
    w52: '#0a0e1a', // Béni Abbès 4
    w55: '#111828', // Touggourt 10
    w38: '#111828', // Tissemsilt 10
    w08: '#1a1a38', // Béchar 11
  };
  Object.entries(wilayaColors).forEach(([id, color]) => {
...
function filterMap(btn, minOrders, maxOrders) {
  ...
  document.querySelectorAll('#algeria-map .wilaya').forEach(g => {
    ...
    if (orders >= minOrders && orders <= maxOrders) {
  ...
  _getOrCreateChart('chartMultiYear', {
    ...
    data: {
      ...
      datasets: [
        ...
        {
          label: 'Revenu (M DZD)',
          data: [8.04, 13.35, 37.52, 18.13, 2.36],
          type: 'line',
          borderColor: '#f59e0b',
