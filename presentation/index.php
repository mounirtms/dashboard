...
<div class="slide" id="s2">
  ...
  <div class="kpi-grid g4" style="margin-bottom:12px">
    <div class="kpi-card blue"><div class="kpi-label">Valid Orders H1 2026</div><div class="kpi-val">519</div><div class="kpi-sub">CMD_Done · Jan–Jun 2026</div><div class="kpi-delta" style="color:var(--ok)">&#x25B2; +16.6% vs 445 (H1 2025)</div></div>
    ...
    <div class="kpi-card green"><div class="kpi-label">All-Time Revenue</div><div class="kpi-val">28.6M</div><div class="kpi-sub">DZD · 4,484 CMD_Done orders</div><div class="kpi-delta" style="color:var(--ok)">2.79M DZD H1 2026 · AOV 5,585</div></div>
    <div class="kpi-card orange"><div class="kpi-label">Cancel Rate H1 2026</div><div class="kpi-val">35.8%</div><div class="kpi-sub">293 cancelled / 819 total</div><div class="kpi-delta" style="color:var(--muted)">Normal for Algerian COD model</div></div>
  </div>
  <div class="kpi-grid g4" style="margin-bottom:12px">
...
<div class="slide section-divider" id="s11">
  ...
  <div class="div-subtitle">7,788 total orders · 4,484 CMD_Done · 9,275 customers · 2022–Jul 2026 · MariaDB prod · Cancel rate 35.8% (Algerian COD)</div>
  <div class="div-tags">
      ...
      <div class="panel">
        ...
        <table class="data-table" style="font-size:12px">
          ...
          <tbody>
            ...
            <tr><td>AOV Moyen (DZD)</td><td class="num">DZD 4,870</td><td class="num">DZD 5,588</td><td><span style="color:var(--ok)">▲ +14.7%</span></td></tr>
            <tr><td>Taux Annulation</td><td class="num">28.4%</td><td class="num">35.8%</td><td><span style="color:var(--warn)">COD normal</span></td></tr>
            ...
            <tr><td>Peak Month</td><td>Jun(72)</td><td>Jan(117)</td><td><span style="color:var(--accent)">Consistent</span></td></tr>
          </tbody>
        </table>
      </div>
      <div class="panel">
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      <div class="panel" style="flex:1">
        ...
        <table class="data-table" style="font-size:11px">
          ...
          <tbody>
            <tr><td>Orders (CMD_Done)</td><td class="num">445</td><td class="num">519</td><td><span style="color:var(--ok)">&#x25B2; +16.6%</span></td></tr>
            <tr><td>Total Revenue</td><td class="num">2.76M DZD</td><td class="num">2.79M DZD</td><td><span style="color:var(--ok)">&#x25B2; +1.1%</span></td></tr>
            <tr><td>Avg Order Value</td><td class="num">6,200 DZD</td><td class="num">5,585 DZD</td><td><span style="color:var(--warn)">&#x25BC; -9.9%</span></td></tr>
            <tr><td>Cancel Rate</td><td class="num">~27%</td><td class="num">35.8%</td><td><span style="color:var(--warn)">&#x25B2; +8.8pp</span></td></tr>
            ...
            <tr><td>Yalidine Orders</td><td class="num">N/A</td><td class="num">183/519 (35.3%)</td><td><span style="color:var(--ok)">&#x25B2; On dev</span></td></tr>
          </tbody>
        </table>
      </div>
      <div class="panel">
...
const NOTES = {
  ...
  s11: 'Phase 3 divider. MariaDB prod: 7,788 total orders. 4,484 CMD_Done (valid). 2,077 cancelled (35.8% — NORMAL for DZ e-commerce COD model, industry 30-50%). 9,275 registered customers. 2022-2026 period.',
  s12: 'Monthly CMD_Done 2026: Jan=117, Feb=68, Mar=75, Apr=81, May=88, Jun=70. Total H1=519. 819 total created. 293 cancelled (35.8%). Jun peak in cancellations (43.9%). Feb lowest (quieter period). Yalidine: 183/519 orders (35.3%).',
  ...
  s15: 'Top products 2026: art supplies dominate. #1 Carton Toile (289 units, 63K DZD). #2 Toile Chassis (126u, 112K DZD). 9,618 catalog products. 694 categories. Yalidine: 183/519 orders. AOV=5,585 DZD. H1 revenue=2.79M DZD.',
  ...
  s17: 'YoY: CMD_Done orders +16.6% (445->519). Revenue H1 2025=2.76M, H1 2026=2.79M (+1.1%). AOV H1 2025=6,200 vs H1 2026=5,585 (-9.9%). Cancel rate rose 8.8pp. Customer count: 577 organic in 2025 vs 537 organic in 2026 + 3278 bulk.',
  s17b:'5-year CMD_Done: 2022=311, 2023=1,359(+337%), 2024=1,163(-14%), 2025=1,132(-2.7%), 2026=519(H1 partial). Revenue: 2022=2.3M, 2023=7.8M, 2024=8.3M, 2025=7.4M. All-time: 4,484 orders, 28.6M DZD. Peak year: 2023.',
  ...
  if (sid === 's13') {
    ...
    _getOrCreateChart('chartCancelRate', {
      ...
      data: {
        ...
        datasets: [{
          label: 'Cancel Rate %',
          data: [32.4, 38.2, 34.7, 31.0, 39.7, 28.9],
          backgroundColor: [
