...
<div class="slide" id="s14">
  ...
  <div class="slide-subtitle">Source: MariaDB customer_entity table — 9,274 total registrations Jan–Jun 2026</div>
  <div class="grid-23" style="flex:1;gap:16px">
    ...
    <div class="col">
      ...
      <div class="anomaly-box">
        <div class="anomaly-title">&#x1F4CB; May 2026 — 3,278 Bulk Registrations (Manual Admin Operation)</div>
        <div style="font-size:11px;color:var(--muted);line-height:1.6">
          <div>• 4.3× normal monthly volume</div>
          <div>• No organic matching order volume — these are migrated guests, not new customers</div>
          ...
          <div style="margin-top:6px"><span class="conf conf-high">HIGH CONFIDENCE</span> — confirmed by admin: manual bulk guest-to-registered conversion</div>
        </div>
      </div>
      <div class="panel">
        <div style="font-size:11px;color:var(--muted)">
          <strong style="color:#fff">Real organic customers:</strong> 9,274 total − 3,278 bulk-migrated = ~5,996 organic<br>
          <strong style="color:#fff">Ordering customers:</strong> 5,180 unique emails placed orders, 1,042 repeat customers<br>
          <strong style="color:#fff">Guest vs registered orders:</strong> 6,978 registered orders, 191 guest orders<br>
          <div style="margin-top:4px;font-size:10px;color:var(--dim)">Source: customer_entity + sales_order · MariaDB · Jul 12, 2026</div>
        </div>
      </div>
    </div>
  </div>
...
<g class="wilaya" id="w_Djanet" 
  ...
  <text x="570" y="554" text-anchor="middle" class="wn">1</text>
</g>
</svg>
    </div>
    <div class="col">
  ...
  <div class="scroll" style="flex:1">
    <table class="data-table">
      ...
      <tbody>
        ...
        <tr><td>12</td><td><strong>May 2026 bulk account registration 3,278</strong></td><td style="font-size:10px">customer_entity COUNT by month</td><td><span class="conf conf-high">HIGH</span></td><td style="font-size:10px">Confirmed admin operation: guest accounts bulk-converted to registered. Password reset emails sent.</td></tr>
...
<div class="slide" id="s36" style="padding:24px 32px 14px">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;margin-bottom:10px">
    ...
    <div class="kpi-card" style="border-color:rgba(34,197,94,.3)">
      <div class="kpi-val" style="color:#4ade80">9,274</div>
...
<div class="slide section-divider" id="s35">
  ...
  <div style="position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;gap:18px;width:100%;padding:20px 32px">
    <!-- Logo -->
    <img src="data:image/png;base64," alt="TechnoStationery" style="height:56px;width:auto;filter:brightness(0) invert(1);opacity:.92;margin-bottom:4px">
    ...
    <div style="display:flex;gap:20px;flex-wrap:wrap;justify-content:center;margin:4px 0">
      <div style="text-align:center;padding:10px 20px;background:rgba(59,130,246,.1);border:1px solid rgba(59,130,246,.25);border-radius:10px">
        <div style="font-size:26px;font-weight:900;color:#fff">9,274</div>
      ...
      <div style="text-align:center;padding:10px 20px;background:rgba(6,182,212,.08);border:1px solid rgba(6,182,212,.2);border-radius:10px">
        <div style="font-size:26px;font-weight:900;color:#fff">7,169</div>
      ...
      <div style="text-align:center;padding:10px 20px;background:rgba(34,197,94,.08);border:1px solid rgba(34,197,94,.2);border-radius:10px">
        <div style="font-size:26px;font-weight:900;color:#fff">96</div>
...
const NOTES = {
  ...
  s14: 'May 2026: 3,278 bulk guest-to-registered conversions by admin. Password reset emails sent. NOT organic. HIGH confidence.',
  ...
  _getOrCreateChart('chartMultiYear', {
    ...
    data: {
      ...
      datasets: [
        ...
        {
          label: 'Revenu (M DZD)',
          data: [7.35, 12.74, 36.70, 10.68, 10.39, 5.42],
          type: 'line',
          borderColor: '#f59e0b',
