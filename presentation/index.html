...
<div class="slide section-divider" id="s11">
  ...
  <div class="div-subtitle">7,117 total orders · 4,484 CMD_Done · 9,275 customers · 2022–Jul 2026 · MariaDB prod · Cancel rate 36.6% (Algerian COD)</div>
  <div class="div-tags">
...
<div class="slide" id="s17b" style="padding:24px 32px 14px">
  ...
  <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:8px;margin-bottom:10px">
    ...
    <div class="kpi-card" style="border-color:rgba(34,197,94,.3)">
      ...
      <div style="font-size:10px;color:#4ade80;margin-top:2px">▲ -14.4% · 8.25M DZD 🏆</div>
    </div>
    ...
    <div class="kpi-card" style="border-color:rgba(148,163,184,.3)">
      ...
      <div style="font-size:10px;color:#64748b;margin-top:2px">H1 2026 · 2.78M DZD</div>
    </div>
  </div>
...
const NOTES = {
  ...
  s12: 'Monthly CMD_Done 2026: Jan=117, Feb=68, Mar=75, Apr=81, May=88, Jun=70. Total H1=498. 786 ordres actifs (498 CMD_Done + 288 annulés). 288 cancelled (36.6%). Jun peak in cancellations (43.9%). Feb lowest (quieter period). Yalidine: 183/498 orders (36.7%).',
  ...
  s17: 'YoY: CMD_Done orders +11.9% (445->498). Revenue H1 2025=2.76M, H1 2026=2.78M (+0.7%). AOV H1 2025=6,560 vs H1 2026=5,591 (-14.8%). Cancel rate rose 8.2pp. Customer count: 577 organic in 2025 vs 537 organic in 2026 + 3278 bulk.',
  s17b:'5-year CMD_Done: 2022=311, 2023=1,359(+337%), 2024=1,163(-14%), 2025=1,133(-2.6%), 2026=498(H1 partial). Revenue: 2022=2.3M, 2023=7.76M, 2024=8.25M, 2025=7.43M. All-time: 4,484 orders, 28.6M DZD. Peak year: 2023.',
