...
1. Check if the files exist:
   ```
   ls -la /home/technadminy7/public_html/pub/media/category_logos/
   ```

2. If the directory doesn't exist, create it:
   ```
   mkdir -p /home/technadminy7/public_html/pub/media/category_logos
   ```
...
4. Set proper permissions:
   ```
   chmod 644 /home/technadminy7/public_html/pub/media/category_logos/*.svg
   chown technadminy7:technadminy7 /home/technadminy7/public_html/pub/media/category_logos/*.svg
   ```
