...
exec('cd /home/betapublic_html && php bin/magento module:enable Custom_DiscountDisplay', $output1, $return1);
if ($return1 === 0) {
...
exec('cd /home/betapublic_html && php bin/magento setup:upgrade', $output2, $return2);
if ($return2 === 0) {
...
exec('cd /home/betapublic_html && php bin/magento cache:flush', $output3, $return3);
if ($return3 === 0) {
