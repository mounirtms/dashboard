...
# Migrates media files from betapublic_html/pub/media to beta installation
# Excludes certain files and directories as specified

# Configuration
SOURCE_MEDIA_DIR="/home/betapublic_html/pub/media"
TARGET_MEDIA_DIR="/home/betabeta/pub/media"
LOG_FILE="/home/betapublic_html/scripts/migration/media-migration.log"
