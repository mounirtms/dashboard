<?php
/**
 * Script to fix guest checkout quote synchronization issues
...
class FixGuestCheckoutQuoteSync implements AppInterface
{
    private $bootstrap;
    ...
    {
        echo "Starting guest checkout quote synchronization fix...\n";
...
// Run the script
$script = new FixGuestCheckoutQuoteSync();
$script->launch();<?php
/**
 * Script to fix guest checkout quote synchronization issues
 * This script will sync customer_id between sales_order and quote tables
