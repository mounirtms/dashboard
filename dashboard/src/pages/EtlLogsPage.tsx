...
const MOCK_LOGS: EtlLogEntry[] = [
  { id: 1, timestamp: '2026-07-08T19:57:00Z', level: 'SUCCESS', source: 'PRICES',    message: 'Price sync completed: 4,812 SKUs updated from MDM → Magento', duration_ms: 14320, records_affected: 4812 },
  { id: 2, timestamp: '2026-07-08T19:57:00Z', level: 'INFO',    source: 'MDM',       message: 'MDM connection established — SQL Server 2019 @ techno-mdm:1433', duration_ms: 230 },
  { id: 3, timestamp: '2026-07-08T19:56:30Z', level: 'INFO',    source: 'CEGID',     message: 'CEGID session opened — Retail 11.4 API v3', duration_ms: 180 },
  { id: 4, timestamp: '2026-07-08T18:30:00Z', level: 'SUCCESS', source: 'INVENTORY', message: 'Inventory sync completed: 3,210 qty adjustments applied', duration_ms: 9800, records_affected: 3210 },
  { id: 5, timestamp: '2026-07-08T18:30:00Z', level: 'WARNING', source: 'INVENTORY', message: '42 SKUs had negative stock in MDM — clamped to 0 in Magento', records_affected: 42 },
  { id: 6, timestamp: '2026-07-08T17:00:00Z', level: 'ERROR',   source: 'PRICES',    message: 'Price sync failed: MDM connection timeout after 30s — retrying in 5min', duration_ms: 30000 },
  { id: 7, timestamp: '2026-07-08T17:05:00Z', level: 'SUCCESS', source: 'PRICES',    message: 'Price sync retry succeeded: 4,812 SKUs updated', duration_ms: 12100, records_affected: 4812 },
  { id: 8, timestamp: '2026-07-08T16:00:00Z', level: 'INFO',    source: 'SCHEDULER', message: 'ETL scheduler heartbeat — next price sync in 60min', duration_ms: 2 },
  { id: 9, timestamp: '2026-07-08T15:00:00Z', level: 'SUCCESS', source: 'PRICES',    message: 'Price sync completed: 4,812 SKUs updated', duration_ms: 13450, records_affected: 4812 },
  { id:10, timestamp: '2026-07-08T14:00:00Z', level: 'DEBUG',   source: 'MDM',       message: 'MDM query: SELECT TOP 5000 sku, price FROM dbo.PriceList WHERE active=1', duration_ms: 1240 },
  { id:11, timestamp: '2026-07-08T13:00:00Z', level: 'SUCCESS', source: 'INVENTORY', message: 'Inventory sync: 3,180 adjustments applied', duration_ms: 9200, records_affected: 3180 },
  { id:12, timestamp: '2026-07-08T12:00:00Z', level: 'WARNING', source: 'CEGID',     message: 'CEGID response slow (8.2s) — possible rate-limit, throttling for 2min' },
  { id:13, timestamp: '2026-07-08T11:00:00Z', level: 'INFO',    source: 'MAGENTO',   message: 'Magento catalog price index triggered after sync', duration_ms: 4100 },
  { id:14, timestamp: '2026-07-08T10:00:00Z', level: 'SUCCESS', source: 'PRICES',    message: 'Price sync completed: 4,812 SKUs updated', duration_ms: 13900, records_affected: 4812 },
  { id:15, timestamp: '2026-07-08T09:00:00Z', level: 'INFO',    source: 'SCHEDULER', message: 'ETL service started — PID 28441, MariaDB 10.6.17 @ localhost:3307', duration_ms: 340 },
];
