...
export default function MagentoSettingsPage() {
  ...
  useEffect(() => {
    fetchMagentoSettings()
      ...
      .catch(e => setToast({ message: getErrMsg(e), severity: 'error' }))
  ...
  const handleFetchToken = async (env: string) => {
    ...
    try {
      ...
      setEnvs(prev => ({ ...prev, [env]: { ...prev[env], fetching: false, testResult: { success: false, message: getErrMsg(e) } } }));
    }
  };
  ...
  const handleTest = async (env: string) => {
    ...
    try {
      ...
      setEnvs(prev => ({ ...prev, [env]: { ...prev[env], testing: false, testResult: { success: false, message: getErrMsg(e) } } }));
    }
  };
