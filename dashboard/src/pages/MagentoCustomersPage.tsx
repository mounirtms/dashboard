...
import { Box, Typography, Button, TextField, Chip, Drawer, IconButton, Tooltip, Snackbar, Alert, InputAdornment, Divider, Grid, Card, CardContent, FormControl, Select, MenuItem, Skeleton } from '@mui/material';
...
export default function MagentoCustomersPage() {
  ...
  if (error && !customers.length) return <Alert severity="error" sx={{ mb: 2 }}>Customers error: {error}</Alert>;
